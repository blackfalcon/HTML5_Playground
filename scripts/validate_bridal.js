function validate() {
	...
	var fieldsToValidate = [fname, lname, address1, city, wedding_date, where_buy_type, state, zip, primary_phone, email];

	//var fieldsToValidate = [submission_date, fname, lname, address1, city, state, zip, primary_phone, item_type, email];
